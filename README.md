...
本仓库当前用于 Aegink 的个人博客，可按需 fork 或二次改造。
...
- 有样式的 [RSS](https://wangyouboke.com/rss.xml) 订阅源链接
...
- 图片加载前显示渐变色占位，提升视觉体验 - [介绍文章](https://wangyouboke.com/post/astro-lqip-implementation)
- 使用 view-transition 实现的流畅的深色模式切换主题过渡动画。
- Markdown 增强 - 链接嵌入功能 - [示例](https://wangyouboke.com/post/my-claude-code-record-2)
- Markdown 增强 - 使用 [@antv/infographic](https://github.com/antvis/Infographic) 创建各种精美的信息图表。
  [Infographic 信息图指南](https://wangyouboke.com/post/infographic-guide)
- 有样式的 RSS 订阅源链接 - [示例](https://wangyouboke.com/rss.xml)
- 公告系统
...
| ----------------------------------------- | ---------- | --------------------------------------------------------------- | ---------------------------- |
| **[忘忧の博客](https://wangyouboke.com/)** | **Aegink** | [Aegink/astro-koharu-blog](https://github.com/Aegink/astro-koharu-blog) | 当前博客                     |
