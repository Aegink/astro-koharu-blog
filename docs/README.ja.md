...
このリポジトリは Aegink の個人ブログ用に保守されています。必要に応じて fork してカスタマイズできます。
...
- スタイル付き [RSS](https://wangyouboke.com/rss.xml) フィードページ
...
- 画像読み込み前のグラデーションプレースホルダーで視覚体験を向上 - [ブログ記事](https://wangyouboke.com/post/astro-lqip-implementation)
- View Transitions API によるスムーズなダークモード切り替えアニメーション
- Markdown 拡張 - リンク埋め込み機能 - [サンプル](https://wangyouboke.com/post/my-claude-code-record-2)
- Markdown 拡張 - [@antv/infographic](https://github.com/antvis/Infographic) で美しいインフォグラフィックを作成
  [インフォグラフィックガイド](https://wangyouboke.com/post/infographic-guide)
- スタイル付き RSS フィードページ - [サンプル](https://wangyouboke.com/rss.xml)
- お知らせシステム
...
| ブログ                                         | 作者       | リポジトリ                                                      | 備考                                   |
| ---------------------------------------------- | ---------- | --------------------------------------------------------------- | -------------------------------------- |
| **[Aegink のブログ](https://wangyouboke.com/)** | **Aegink** | [Aegink/astro-koharu-blog](https://github.com/Aegink/astro-koharu-blog) | 現在のブログ                            |
