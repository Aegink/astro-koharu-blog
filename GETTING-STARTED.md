...
# 2. 添加上游仓库（只需执行一次）
git remote add upstream https://github.com/Aegink/astro-koharu-blog.git
...
- 重大版本更新请查看 [Release Notes](https://github.com/Aegink/astro-koharu-blog/releases) 了解破坏性变更

## 获取帮助

- 📖 [详细使用指南](./src/content/blog/tools/astro-koharu-guide.md)
- 🐛 [提交 Issue](https://github.com/Aegink/astro-koharu-blog/issues)
- ⭐ [GitHub 仓库](https://github.com/Aegink/astro-koharu-blog)
